...
# installing package if not already installed - the require function here will output TRUE 
# if XML is already installed - the `!` (read 'not') in front of it means that we only 
# want to install it if this is not the case
if (!require(XML)) {
...
ta <- read_delim("data/temp_anomaly.txt", skip = 9, delim = "\t", 
