...
Two PhD students, after a long evening, were arguing about fundamental research questions. They were wondering whether the liberalization of private drug use (such as cannabis and harder narcotics) would lead to an increase in violence and in episodes of (collective) psychosis. To find out whether narcotics have such negative effects, the two economists gathered the two following datasets:
...
$$total.views.year = \alpha + \beta *\text{Legalization\_medical} + \delta *\text{as.factor(state)} + \gamma *\text{as.factor(year)} + u.$$
