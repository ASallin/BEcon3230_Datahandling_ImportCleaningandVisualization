...
What kind of person does all this? [Think of him or her as a hybrid of data hacker, analyst, communicator, and trusted adviser. The combination is extremely powerful — and rare.]{.green-bold}"
...
tab |> 
  ...
  row_spec(c(1, 3, 4, 6, 7, 8), bold = T, color = "green") |> 
  row_spec(c(1, 2, 4, 6, 7, 9), extra_css = "border-bottom: 20px solid white;") |> 
  row_spec(c(1, 3, 5, 8), extra_css = "border-bottom: 0px solid white;")
```
...
tab |> 
  ...
  column_spec(1, width = "200px") |>
  column_spec(2, width = "950px") |>
  row_spec(c(1, 3), bold = T, color = "green") |> 
  row_spec(c(2), bold = T, color = "firebrick4") |> 
