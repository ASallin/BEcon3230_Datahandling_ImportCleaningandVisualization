...
- Go to this app (use the QR code): [https://datahandling.shinyapps.io/DataHandlingIntro/](https://datahandling.shinyapps.io/DataHandlingIntro/)
...
- **Use essential tools for working with data** <br> We will work with the programming language R, but the concepts apply to any programming language.
