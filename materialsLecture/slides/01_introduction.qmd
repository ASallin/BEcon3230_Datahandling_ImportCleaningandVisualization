...
tab |>
  ...
  row_spec(c(1, 3, 4, 6, 7, 8, 10), bold = T, color = "green") |>
  row_spec(7, bold = T, color = "firebrick4") |>
  row_spec(c(2, 3, 5, 6, 7, 9), extra_css = "border-bottom: 20px solid white;") |>
  row_spec(c(1, 8), extra_css = "border-bottom: 0px solid white;")
```
...
tab |>
    ...
    column_spec(1, width = "200px") |>
    column_spec(2, width = "950px") |>
    row_spec(c(1, 2), bold = T, color = "firebrick4") |>
    row_spec(c(3, 5, 6), bold = T, color = "green") |>
    row_spec(c(2, 4, 5), extra_css = "border-bottom: 25px solid white;") |>
    row_spec(c(1, 2), extra_css = "border-bottom: 0px solid white;")
```
...
tab |>
  ...
  row_spec(c(4), bold = T, color = "firebrick4") |>
  row_spec(c(1, 3), extra_css = "border-bottom: 25px solid white;") |>
  row_spec(c(2, 4), extra_css = "border-bottom: 0px solid white;")
```
