...
subtitle: 'Lecture 8:<br>Data Preparation, Manipulation, and Cleaning II'
...
include_graphics("../../img/panel_crosssection_timeseries.svg")
```
:::
...
- <span style="color:red">**Statistical models**</span> like regressions where each predictor should be a separate column (`lm`), many machine learning functions, matrix multiplication (erratum last time!)
