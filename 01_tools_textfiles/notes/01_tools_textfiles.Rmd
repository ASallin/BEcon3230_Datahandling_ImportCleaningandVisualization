...
subtitle: 'Notes for Exercise/Workshop 1: Tools, Working with Text Files'
...
```{r rstudio, echo=FALSE, fig.align='center', fig.cap="Running R in RStudio (IDE).", out.width="75%", purl=FALSE}
