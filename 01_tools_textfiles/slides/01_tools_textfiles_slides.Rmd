...
Hint: You can access your terminal in RStudio.
 ...
 - Next, pull changes from the course repo to update your local copy. In the terminal, navigate to the course repository (the 'datahandling' folder on your computer) and run ```git pull origin master```. What message do you see?

- Go to the 'datahandling' repo. Where can issues be raised? If an issue is raised in this repo, who can see it? 
